...
class HTMXIndividualListView(generic.ListView):
...
class HTMXIndividualCreateView(generic.CreateView):
    model = models.Individual
    form_class = forms.IndividualForm
...
class HTMXIndividualDeleteView(generic.DeleteView):
    model = models.Individual
    success_url = reverse_lazy("speaker_individual_htmx_list")
